...
chrome.storage.sync.get(['myTime'], function(result) {
    useTime = result.myTime;
    console.log("Time : "+useTime);
});
...
setTimeout(function(){
  var x = document.getElementsByClassName('_1SP8R');
  var y = getRandomInt(0, 9);
  x[0].innerHTML="<h1 style=\"font-size: 25px; line-height: 1.2;\">"+quotes[y]+"</h1>";
},5000);
